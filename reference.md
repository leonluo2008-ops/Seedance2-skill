...
```
将视频1中的角色替换成图片1中的太空猫，动作和运镜不变，保持纯白背景。
```

**关键技巧**：
- 提示词说清楚"替换谁"和"保留什么"（运镜、背景、动作）
- 图片作为新角色输入（`role: reference_image`）
- 视频作为动作参考（`role: reference_video`，自动从 nginx 公网 URL 传入）
- 背景建议与原视频一致，避免风格混淆

### 角色反应描述法（避免道具触发）

**问题**："被刷洗""吃东西""被抚摸"等描述动作的词会触发道具生成（刷子、食物、手）。

**原因**：Seedance 理解了"被 X" = 生成 X 道具。

**解决核心**：从**角色反应**出发描述，不要描述动作本身。

| ❌ 触发道具 | ✅ 只描述反应 |
|------------|-------------|
| 被刷洗、洗澡 | 眯眼微笑、耳朵颤动、尾巴轻快摆动、身体微微晃动 |
| 吃东西、张嘴 | 啄食节奏、眼睛亮晶晶、嘴角反复上扬、鼻子抽动（见 Recipe） |
| 被抚摸、挠痒 | 眯眼、耳朵贴平、嘴角上扬、身体蹭靠 |
...
**示例（猫咪享受洗澡动画）**：
```
纯像素画风格，像素块大小统一，边缘锐利。全景固定镜头，角色全身居中正面坐着，双手放在身前，开心享受地眯眼微笑，耳朵轻微颤动，嘴巴微张，尾巴轻快左右摇摆，身体微微左右晃动，眼睛自然低频眨眼，表情循环渐变。动作流畅连贯，首尾无缝衔接。纯白背景，无任何道具或异物出现，禁止出现刷子或清洁工具。保持在画面中央不位移，无透视变化。
```
...
### ⚠️ Q版角色四足行走问题（2026-04-25 实测教训）

**问题**：Q 版比例角色（头大身小）容易被 Seedance 误解为两足直立人形，而非四足着地行走。

**实测**：太空猫背面行走首帧图（17b89e32）本身 Q 版比例偏直立感，即使在 prompt 中强化"四足着地""禁止两足直立"，模型仍生成直立行走。

**根本原因**：首帧图本身的几何特征决定了模型的理解方向。

**解决方案**：
- 四足行走姿态必须在**首帧图中明确展示四足几何特征**
- 不能依赖视频生成阶段强制修正
- 问题应在**工段2（首帧图生成）**阶段处理，不应在工段3硬调

**教训**：
1. 视频生成成本高，prompt 写错浪费资金
2. 首帧图视角/姿态问题无法在工段3强制调整
3. 执行前必须先识别参考图内容，与用户确认后再执行

### 猫咪吃东西动画 Recipe（v4 验证成功）

**成功场景**：太空猫像素风吃零食动画，灵动吃货感，无食物道具 ✅

**核心要素（缺一不可）**：
- **啄食节奏**：类似小鸡啄米般轻快有力的头部点头动作（这是灵魂）
- **身体起伏**：配合吃东西节奏微微上下起伏
- **灵动细节**：眼睛亮晶晶睁大、鼻子轻轻抽动、耳朵时而前倾轻抖
- **尾巴甩动**：兴奋地左右摆动
- **表情循环**：期待 → 吃到 → 满足 → 意犹未尽（渐变）
- **时长**：建议 8 秒（比 5 秒节奏感更好）

**成功 Prompt 示例**：
```
纯像素画风格，像素块大小统一，边缘锐利，无抗锯齿。全景固定镜头，正面平视，角色全身居中正面坐着。猫咪正在吃东西，表情灵动活泼：眼睛亮晶晶地微微睁大，嘴角反复上扬做舔嘴回味状，鼻子轻轻抽动感知气味，耳朵时而前倾时而轻抖，尾巴兴奋地甩动，身体随着吃东西的节奏微微上下起伏，头部有细微的近距离啄食动作（类似小鸡啄米般轻快有力的节奏），双手放在身前自然蜷缩。表情从期待到吃到到满足到意犹未尽，循环渐变，节奏轻快不呆板。动作流畅连贯，首尾无缝衔接。纯白背景，无任何食物、餐具或异物出现。保持在画面中央不位移，无透视变化。
```

**通用化**：替换角色名称、去掉像素风相关词，可用于任何角色的吃东西场景。

### 猫咪洗澡后甩水动画 Recipe（v5 验证成功）

**成功场景**：太空猫像素风洗澡后梳理反应动画，灵动舒服感，无水滴道具 ✅

**核心要素（缺一不可）**：
- **抖毛甩动**：身体左右快速抖毛甩动（核心动作）
- **毛发蓬松**：洗澡后毛发蓬松微竖的状态
- **舒展伸懒腰**：前爪伸展，身体微微晃动
- **表情舒服**：眯眼舒服满意、打哈欠般的舒展
- **辅助细节**：耳朵轻摆、尾巴缓慢摇摆
...
**成功 Prompt 示例**：
```
纯像素画风格，像素块大小统一，边缘锐利，无抗锯齿。全景固定镜头，正面平视，角色全身居中正面坐着。猫咪刚洗完澡，展现梳理反应：毛发蓬松微竖，身体左右快速抖毛甩动，舒展前爪伸懒腰，耳朵轻轻摆动，眯眼露出舒服满意的表情，嘴巴微张打哈欠般的舒展状，尾巴缓慢摇摆，身体微微晃动。动作流畅，节奏从慢到快再到慢，循环渐变。动作流畅连贯，首尾无缝衔接。纯白背景，无任何水滴或水珠或洗澡工具或异物出现，禁止出现任何道具。保持在画面中央不位移，无透视变化。
```

**策略**：不提"水"字，用身体反应描述替代，避免触发水滴/水珠道具

**通用化**：替换角色名称，可用于任何角色的洗澡后反应场景
...
**Prompt 示例**：
```
纯像素画风格，像素块大小统一，边缘锐利，无抗锯齿。全景固定镜头，正面平视，角色全身居中正面坐着。猫咪头部歪向一侧，身体微微侧倾，后腿抬起做出挠痒动作，表情舒服自然，尾巴随动作轻摆。动作循环渐变，停顿后自然回正。动作流畅连贯，首尾无缝衔接。纯白背景，无任何爪子、挠痒工具或异物出现，禁止出现任何道具。保持在画面中央不位移，无透视变化。
```

**策略**：不提"爪子/挠痒挠"字，用"后腿抬起做出挠痒动作"替代，避免触发爪子道具
