...
python3 scripts/seedance.py create --prompt "参考视频的运镜和节奏" --video-ref reference.mp4 --wait --download ~/Desktop
...
| 模型 | Model ID | 能力 |
|------|----------|------|
| **Seedance 2.0**（默认） | `doubao-seedance-2-0-fast-260128` | 文/图/视频/音频多模态、运动复刻、多镜头叙事 |
...
| `--video-ref` | 参考视频（1-3 个，Seedance 2.0） |
